...
| ------------- | ------------- | ------------- |
| [**designAtomsPrintProductItemsApplyItemEffects()**](DesignAtomsPrintProductItemsApi.md#designAtomsPrintProductItemsApplyItemEffects) | **POST** /api/atoms/v1/designs/print-product/items/apply-effects | Apply effects to print-product item image. |
...
```php
designAtomsPrintProductItemsApplyItemEffects($tenant_id, $body): mixed
```
...
try {
    $result = $apiInstance->designAtomsPrintProductItemsApplyItemEffects($tenant_id, $body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DesignAtomsPrintProductItemsApi->designAtomsPrintProductItemsApplyItemEffects: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
designAtomsPrintProductItemsBatchCreateItemsFromFile($item_type, $tenant_id, $source_files, $palette_uid, $preserve_original_file): mixed
```
...
try {
    $result = $apiInstance->designAtomsPrintProductItemsBatchCreateItemsFromFile($item_type, $tenant_id, $source_files, $palette_uid, $preserve_original_file);
    print_r($result);
} catch (Exception $e) {
...
```php
designAtomsPrintProductItemsFlattenItems($palette_uid, $tenant_id, $request_body): mixed
```
...
try {
    $result = $apiInstance->designAtomsPrintProductItemsFlattenItems($palette_uid, $tenant_id, $request_body);
    print_r($result);
} catch (Exception $e) {
