<?php
/**
 * DesignSurfaceContainerParamsLimitedColorSettings
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DesignSurfaceContainerParamsLimitedColorSettings Class Doc Comment
 *
 * @category Class
 * @description Limited color container settings. If container mode is not &#39;LimitedColor&#39;, null value will be provided.
 * @package  Aurigma\DesignAtoms
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DesignSurfaceContainerParamsLimitedColorSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DesignSurfaceContainerParams_limitedColorSettings';
    ...
    */
     ...
     * Sets colors
     *
     * @param int|null $colors Colors limit count.
     *
     * @return self
     */
     ...
     * Sets palette_uid
     *
     * @param string|null $palette_uid Related palette UID.
     *
     * @return self
     */
