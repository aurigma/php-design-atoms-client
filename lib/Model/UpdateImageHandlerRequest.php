    ...
    */
    ...
    public function setActualSize($actual_size)
    {
        if (is_null($actual_size)) {
            throw new \InvalidArgumentException('non-nullable actual_size cannot be null');
        }
    ...
    public function setPreserveAspectRatio($preserve_aspect_ratio)
    {
        if (is_null($preserve_aspect_ratio)) {
            throw new \InvalidArgumentException('non-nullable preserve_aspect_ratio cannot be null');
        }
