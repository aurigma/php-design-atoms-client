...
class FontsMethodData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'requested_fonts_by_ps_name' => true,
        'advanced_mode' => false,
        'base_url' => true
    ];
    ...
    {
        $this->setIfExists('requested_fonts_by_ps_name', $data ?? [], null);
        $this->setIfExists('advanced_mode', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($requested_fonts_by_ps_name)) {
            array_push($this->openAPINullablesSetToNull, 'requested_fonts_by_ps_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('requested_fonts_by_ps_name', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($advanced_mode)) {
            throw new \InvalidArgumentException('non-nullable advanced_mode cannot be null');
        }
