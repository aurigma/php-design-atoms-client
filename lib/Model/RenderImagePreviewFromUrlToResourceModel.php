...
/**
 * RenderImagePreviewFromUrlToResourceModel Class Doc Comment
 *
 * @category Class
 * @description Image preview rendering parameters. Result will be saved as resource with parameters set as Aurigma.DesignAtomsApi.WebApi.Models.Image.RenderImagePreviewFromUrlToResourceModel.PreviewResourceParams.
 * @package  Aurigma\DesignAtoms
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RenderImagePreviewFromUrlToResourceModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RenderImagePreviewFromUrlToResourceModel';
    ...
    */
     ...
     * Sets image_url
     *
     * @param string|null $image_url Web image URL.
     *
     * @return self
     */
