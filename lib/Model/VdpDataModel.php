...
class VdpDataModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('vdp_data_set', $data ?? [], null);
        $this->setIfExists('vdp_items_data', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($vdp_data_set)) {
            array_push($this->openAPINullablesSetToNull, 'vdp_data_set');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('vdp_data_set', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($vdp_items_data)) {
            array_push($this->openAPINullablesSetToNull, 'vdp_items_data');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('vdp_items_data', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
