 ...
 */
class DesignSurfaceDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DesignSurfaceDto';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Surface identifier.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Surface name.
     *
     * @return self
     */
