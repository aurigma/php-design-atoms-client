...
/**
 * DesignAtomsPalettesApi Class Doc Comment
 *
 * @category Class
 * @package  Aurigma\DesignAtoms
 * @author   OpenAPI Generator team
...
class DesignAtomsPalettesApi
{
    ...
    /**
     * Operation designAtomsPalettesFindPaletteColor
     *
    ...
    {
        list($response) = $this->designAtomsPalettesFindPaletteColorWithHttpInfo($palette_uid, $tenant_id, $body, $contentType);
        return $response;
    }

    /**
     * Operation designAtomsPalettesFindPaletteColorWithHttpInfo
     *
     * Returns a closest color to provided color in a specified palette.
     *
     * @param  string $palette_uid Palette UID. (optional)
    ...
    /**
     * Operation designAtomsPalettesFindPaletteColorAsync
     *
     * Returns a closest color to provided color in a specified palette.
     *
     * @param  string $palette_uid Palette UID. (optional)
     ...
     */
    public function designAtomsPalettesFindPaletteColorAsync($palette_uid = null, $tenant_id = null, $body = null, string $contentType = self::contentTypes['designAtomsPalettesFindPaletteColor'][0])
    {
        return $this->designAtomsPalettesFindPaletteColorAsyncWithHttpInfo($palette_uid, $tenant_id, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation designAtomsPalettesFindPaletteColorAsyncWithHttpInfo
     *
     * Returns a closest color to provided color in a specified palette.
     *
     * @param  string $palette_uid Palette UID. (optional)
     ...
     */
    public function designAtomsPalettesFindPaletteColorRequest($palette_uid = null, $tenant_id = null, $body = null, string $contentType = self::contentTypes['designAtomsPalettesFindPaletteColor'][0])
    {
        ...
        $resourcePath = '/api/atoms/v1/palettes/find-color';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation designAtomsPalettesGetPaletteModel
     *
    ...
    {
        list($response) = $this->designAtomsPalettesGetPaletteModelWithHttpInfo($id, $uid, $tenant_id, $contentType);
        return $response;
    }

    /**
     * Operation designAtomsPalettesGetPaletteModelWithHttpInfo
     *
     * Returns a serialized palette model by its identifier or UID.
     *
     * @param  string $id Palette identifier. (optional)
    ...
    {
        $request = $this->designAtomsPalettesGetPaletteModelRequest($id, $uid, $tenant_id, $contentType);
    ...
    /**
     * Operation designAtomsPalettesGetPaletteModelAsync
     *
     * Returns a serialized palette model by its identifier or UID.
     *
     * @param  string $id Palette identifier. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function designAtomsPalettesGetPaletteModelAsync($id = null, $uid = null, $tenant_id = null, string $contentType = self::contentTypes['designAtomsPalettesGetPaletteModel'][0])
    {
        return $this->designAtomsPalettesGetPaletteModelAsyncWithHttpInfo($id, $uid, $tenant_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation designAtomsPalettesGetPaletteModelAsyncWithHttpInfo
     *
     * Returns a serialized palette model by its identifier or UID.
     *
     * @param  string $id Palette identifier. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function designAtomsPalettesGetPaletteModelAsyncWithHttpInfo($id = null, $uid = null, $tenant_id = null, string $contentType = self::contentTypes['designAtomsPalettesGetPaletteModel'][0])
    {
        $returnType = 'mixed';
        $request = $this->designAtomsPalettesGetPaletteModelRequest($id, $uid, $tenant_id, $contentType);
    ...
    /**
     * Create request for operation 'designAtomsPalettesGetPaletteModel'
     *
     * @param  string $id Palette identifier. (optional)
     * @param  string $uid Palette UID. (optional)
     * @param  int $tenant_id Tenant ID. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function designAtomsPalettesGetPaletteModelRequest($id = null, $uid = null, $tenant_id = null, string $contentType = self::contentTypes['designAtomsPalettesGetPaletteModel'][0])
    {
        ...
        $resourcePath = '/api/atoms/v1/palettes/model';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
